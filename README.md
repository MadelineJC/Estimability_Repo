...
Data generated by steps (2) and (3) above can be found in the `0_Data` folder. Fitting scripts generated by step (4) above can be found in the `1_Model` folder. If you want to skip fitting the data-generating models to data, you can use the fit objects (`.rds` files) stored in the `2_FitObjects` folder to execute step (5) above.
