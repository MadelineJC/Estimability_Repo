...
ExtractFcn <- function(x, y){
  vec <- as.vector(rstan::extract(x, pars = y)[[1]])
  vec <- sort(vec)
   vec <- vec[201:3800]
  return(vec)
}
...
# B
MFP_2.1_DO_B <- ExtractFcn(ModFentonPerkins_2_DO_FitObj1, "theta[2]")
MFP_2.2_DO_B <- ExtractFcn(ModFentonPerkins_2_DO_FitObj2, "theta[2]")
MFP_2.3_DO_B <- ExtractFcn(ModFentonPerkins_2_DO_FitObj3, "theta[2]")
MFP_2.4_DO_B <- ExtractFcn(ModFentonPerkins_2_DO_FitObj4, "theta[2]")
MFP_2.5_DO_B <- ExtractFcn(ModFentonPerkins_2_DO_FitObj5, "theta[2]")
MFP_2.1_SLC_B <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj1, "theta[2]")
MFP_2.2_SLC_B <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj2, "theta[2]")
MFP_2.3_SLC_B <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj3, "theta[2]")
MFP_2.4_SLC_B <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj4, "theta[2]")
MFP_2.5_SLC_B <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj5, "theta[2]")
MFP_2.1_DivO_B <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj1, "theta[2]")
MFP_2.2_DivO_B <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj2, "theta[2]")
MFP_2.3_DivO_B <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj3, "theta[2]")
MFP_2.4_DivO_B <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj4, "theta[2]")
MFP_2.5_DivO_B <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj5, "theta[2]")

# h
MFP_2.1_DO_h <- ExtractFcn(ModFentonPerkins_2_DO_FitObj1, "theta[3]")
MFP_2.2_DO_h <- ExtractFcn(ModFentonPerkins_2_DO_FitObj2, "theta[3]")
MFP_2.3_DO_h <- ExtractFcn(ModFentonPerkins_2_DO_FitObj3, "theta[3]")
MFP_2.4_DO_h <- ExtractFcn(ModFentonPerkins_2_DO_FitObj4, "theta[3]")
MFP_2.5_DO_h <- ExtractFcn(ModFentonPerkins_2_DO_FitObj5, "theta[3]")
MFP_2.1_SLC_h <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj1, "theta[3]")
MFP_2.2_SLC_h <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj2, "theta[3]")
MFP_2.3_SLC_h <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj3, "theta[3]")
MFP_2.4_SLC_h <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj4, "theta[3]")
MFP_2.5_SLC_h <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj5, "theta[3]")
MFP_2.1_DivO_h <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj1, "theta[3]")
MFP_2.2_DivO_h <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj2, "theta[3]")
MFP_2.3_DivO_h <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj3, "theta[3]")
MFP_2.4_DivO_h <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj4, "theta[3]")
MFP_2.5_DivO_h <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj5, "theta[3]")

# e
MFP_2.1_DO_e <- ExtractFcn(ModFentonPerkins_2_DO_FitObj1, "theta[5]")
MFP_2.2_DO_e <- ExtractFcn(ModFentonPerkins_2_DO_FitObj2, "theta[5]")
MFP_2.3_DO_e <- ExtractFcn(ModFentonPerkins_2_DO_FitObj3, "theta[5]")
MFP_2.4_DO_e <- ExtractFcn(ModFentonPerkins_2_DO_FitObj4, "theta[5]")
MFP_2.5_DO_e <- ExtractFcn(ModFentonPerkins_2_DO_FitObj5, "theta[5]")
MFP_2.1_SLC_e <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj1, "theta[5]")
MFP_2.2_SLC_e <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj2, "theta[5]")
MFP_2.3_SLC_e <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj3, "theta[5]")
MFP_2.4_SLC_e <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj4, "theta[5]")
MFP_2.5_SLC_e <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj5, "theta[5]")
MFP_2.1_DivO_e <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj1, "theta[5]")
MFP_2.2_DivO_e <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj2, "theta[5]")
MFP_2.3_DivO_e <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj3, "theta[5]")
MFP_2.4_DivO_e <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj4, "theta[5]")
MFP_2.5_DivO_e <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj5, "theta[5]")

# d
MFP_2.1_DO_d <- ExtractFcn(ModFentonPerkins_2_DO_FitObj1, "theta[6]")
MFP_2.2_DO_d <- ExtractFcn(ModFentonPerkins_2_DO_FitObj2, "theta[6]")
MFP_2.3_DO_d <- ExtractFcn(ModFentonPerkins_2_DO_FitObj3, "theta[6]")
MFP_2.4_DO_d <- ExtractFcn(ModFentonPerkins_2_DO_FitObj4, "theta[6]")
MFP_2.5_DO_d <- ExtractFcn(ModFentonPerkins_2_DO_FitObj5, "theta[6]")
MFP_2.1_SLC_d <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj1, "theta[6]")
MFP_2.2_SLC_d <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj2, "theta[6]")
MFP_2.3_SLC_d <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj3, "theta[6]")
MFP_2.4_SLC_d <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj4, "theta[6]")
MFP_2.5_SLC_d <- ExtractFcn(ModFentonPerkins_2_SLC_FitObj5, "theta[6]")
MFP_2.1_DivO_d <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj1, "theta[6]")
MFP_2.2_DivO_d <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj2, "theta[6]")
MFP_2.3_DivO_d <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj3, "theta[6]")
MFP_2.4_DivO_d <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj4, "theta[6]")
MFP_2.5_DivO_d <- ExtractFcn(ModFentonPerkins_2_DivOsc_FitObj5, "theta[6]")

## Plotting
### B ###
Models <- c("MFP_2.1_DO_B", "MFP_2.2_DO_B", "MFP_2.3_DO_B", "MFP_2.4_DO_B", "MFP_2.5_DO_B",
           "MFP_2.1_SLC_B", "MFP_2.2_SLC_B", "MFP_2.3_SLC_B", "MFP_2.4_SLC_B", "MFP_2.5_SLC_B",
           "MFP_2.1_DivO_B", "MFP_2.2_DivO_B", "MFP_2.3_DivO_B", "MFP_2.4_DivO_B", "MFP_2.5_DivO_B")
x.labs <- rep(c("TS 1", "TS 2", "TS 3", "TS 4","TS 5"), 5)
df.B <- data.frame(Models = rep(Models, each = 3600),
                   Est = c(MFP_2.1_DO_B, MFP_2.2_DO_B, MFP_2.3_DO_B, MFP_2.4_DO_B, MFP_2.5_DO_B,
                           MFP_2.1_SLC_B, MFP_2.2_SLC_B, MFP_2.3_SLC_B, MFP_2.4_SLC_B, MFP_2.5_SLC_B,
                           MFP_2.1_DivO_B, MFP_2.2_DivO_B, MFP_2.3_DivO_B, MFP_2.4_DivO_B, MFP_2.5_DivO_B),
                   TrueVal = rep(c(0.008, 0.012, 0.012), each = 18000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 18000))

Global.B <- ggplot(df.B, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  ylim(0, 0.03) +
  labs(x = "", y = expression(paste("Model Estimates of ", beta))) +
  scale_fill_manual(values = c("orange", "orchid", "lightblue"), 
                    breaks = c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations")) +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
                     axis.text.x = element_text(colour = rep(c("orange", "orchid", "lightblue"), each = 5))) +
  geom_point(aes(y = TrueVal)) +
  guides(fill = "none")
Global.B

### h ###
Models <- c("MFP_2.1_DO_h", "MFP_2.2_DO_h", "MFP_2.3_DO_h", "MFP_2.4_DO_h", "MFP_2.5_DO_h",
           "MFP_2.1_SLC_h", "MFP_2.2_SLC_h", "MFP_2.3_SLC_h", "MFP_2.4_SLC_h", "MFP_2.5_SLC_h",
           "MFP_2.1_DivO_h", "MFP_2.2_DivO_h", "MFP_2.3_DivO_h", "MFP_2.4_DivO_h", "MFP_2.5_DivO_h")
x.labs <- rep(c("TS 1", "TS 2", "TS 3", "TS 4","TS 5"), 5)
df.h <- data.frame(Models = rep(Models, each = 3600),
                   Est = c(MFP_2.1_DO_h, MFP_2.2_DO_h, MFP_2.3_DO_h, MFP_2.4_DO_h, MFP_2.5_DO_h,
                           MFP_2.1_SLC_h, MFP_2.2_SLC_h, MFP_2.3_SLC_h, MFP_2.4_SLC_h, MFP_2.5_SLC_h,
                           MFP_2.1_DivO_h, MFP_2.2_DivO_h, MFP_2.3_DivO_h, MFP_2.4_DivO_h, MFP_2.5_DivO_h),
                   TrueVal = rep(c(0.06, 0.075, 0.075), each = 18000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 18000))

Global.h <- ggplot(df.h, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  labs(x = "", y = expression(paste("Model Estimates of ", italic("h")))) +
  scale_fill_manual(values = c("orange", "orchid", "lightblue"), 
                    breaks = c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations")) +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
### e ###
Models <- c("MFP_2.1_DO_e", "MFP_2.2_DO_e", "MFP_2.3_DO_e", "MFP_2.4_DO_e", "MFP_2.5_DO_e",
           "MFP_2.1_SLC_e", "MFP_2.2_SLC_e", "MFP_2.3_SLC_e", "MFP_2.4_SLC_e", "MFP_2.5_SLC_e",
           "MFP_2.1_DivO_e", "MFP_2.2_DivO_e", "MFP_2.3_DivO_e", "MFP_2.4_DivO_e", "MFP_2.5_DivO_e")
x.labs <- rep(c("TS 1", "TS 2", "TS 3", "TS 4","TS 5"), 5)
df.e <- data.frame(Models = rep(Models, each = 3600),
                   Est = c(MFP_2.1_DO_e, MFP_2.2_DO_e, MFP_2.3_DO_e, MFP_2.4_DO_e, MFP_2.5_DO_e,
                           MFP_2.1_SLC_e, MFP_2.2_SLC_e, MFP_2.3_SLC_e, MFP_2.4_SLC_e, MFP_2.5_SLC_e,
                           MFP_2.1_DivO_e, MFP_2.2_DivO_e, MFP_2.3_DivO_e, MFP_2.4_DivO_e, MFP_2.5_DivO_e),
                   TrueVal = rep(c(0.2, 0.3, 0.3), each = 18000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 18000))

Global.e <- ggplot(df.e, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  #ylim(0, 0.03) +
  labs(x = "", y = expression(paste("Model Estimates of ", italic("e")))) +
  scale_fill_manual(values = c("orange", "orchid", "lightblue"), 
                    breaks = c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations")) +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
### d ###
Models <- c("MFP_2.1_DO_d", "MFP_2.2_DO_d", "MFP_2.3_DO_d", "MFP_2.4_DO_d", "MFP_2.5_DO_d",
           "MFP_2.1_SLC_d", "MFP_2.2_SLC_d", "MFP_2.3_SLC_d", "MFP_2.4_SLC_d", "MFP_2.5_SLC_d",
           "MFP_2.1_DivO_d", "MFP_2.2_DivO_d", "MFP_2.3_DivO_d", "MFP_2.4_DivO_d", "MFP_2.5_DivO_d")
x.labs <- rep(c("TS 1", "TS 2", "TS 3", "TS 4","TS 5"), 5)
df.d <- data.frame(Models = rep(Models, each = 3600),
                   Est = c(MFP_2.1_DO_d, MFP_2.2_DO_d, MFP_2.3_DO_d, MFP_2.4_DO_d, MFP_2.5_DO_d,
                           MFP_2.1_SLC_d, MFP_2.2_SLC_d, MFP_2.3_SLC_d, MFP_2.4_SLC_d, MFP_2.5_SLC_d,
                           MFP_2.1_DivO_d, MFP_2.2_DivO_d, MFP_2.3_DivO_d, MFP_2.4_DivO_d, MFP_2.5_DivO_d),
                   TrueVal = rep(c(0.2, 0.41, 0.48), each = 18000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 18000))

Global.d <- ggplot(df.d, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  #ylim(0, 0.03) +
  labs(x = "", y = expression(paste("Model Estimates of ", delta))) +
  scale_fill_manual(values = c("orange", "orchid", "lightblue"), 
                    breaks = c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations")) +
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"),
...
### Plotting Together ###
Global.Plots <- plot_grid(Global.B, Global.h, Global.e, Global.d, nrow = 4)
title <- textGrob("MFP Model, Type II FR | Global Model-Fitting")
x.lab <- textGrob("Generating Model and Corresponding Time Series")
grid.arrange(arrangeGrob(Global.Plots, top = title, bottom = x.lab))
```
...
# r
MFP_2.1_DO_r <- ExtractFcn(MFP.II.DampOsc.1.AR.Fit, "r")
MFP_2.2_DO_r <- ExtractFcn(MFP.II.DampOsc.2.AR.Fit, "r")
MFP_2.3_DO_r <- ExtractFcn(MFP.II.DampOsc.3.AR.Fit, "r")
MFP_2.4_DO_r <- ExtractFcn(MFP.II.DampOsc.4.AR.Fit, "r")
MFP_2.5_DO_r <- ExtractFcn(MFP.II.DampOsc.5.AR.Fit, "r")
MFP_2.1_SLC_r <- ExtractFcn(MFP.II.SLC.1.AR.Fit, "r")
MFP_2.2_SLC_r <- ExtractFcn(MFP.II.SLC.2.AR.Fit, "r")
MFP_2.3_SLC_r <- ExtractFcn(MFP.II.SLC.3.AR.Fit, "r")
MFP_2.4_SLC_r <- ExtractFcn(MFP.II.SLC.4.AR.Fit, "r")
MFP_2.5_SLC_r <- ExtractFcn(MFP.II.SLC.5.AR.Fit, "r")
MFP_2.1_DivO_r <- ExtractFcn(MFP.II.DivOsc.1.AR.Fit, "r")
MFP_2.2_DivO_r <- ExtractFcn(MFP.II.DivOsc.2.AR.Fit, "r")
MFP_2.3_DivO_r <- ExtractFcn(MFP.II.DivOsc.3.AR.Fit, "r")
MFP_2.4_DivO_r <- ExtractFcn(MFP.II.DivOsc.4.AR.Fit, "r")
MFP_2.5_DivO_r <- ExtractFcn(MFP.II.DivOsc.5.AR.Fit, "r")

# d
MFP_2.1_DO_d <- ExtractFcn(MFP.II.DampOsc.1.AR.Fit, "delta")
MFP_2.2_DO_d <- ExtractFcn(MFP.II.DampOsc.2.AR.Fit, "delta")
MFP_2.3_DO_d <- ExtractFcn(MFP.II.DampOsc.3.AR.Fit, "delta")
MFP_2.4_DO_d <- ExtractFcn(MFP.II.DampOsc.4.AR.Fit, "delta")
MFP_2.5_DO_d <- ExtractFcn(MFP.II.DampOsc.5.AR.Fit, "delta")
MFP_2.1_SLC_d <- ExtractFcn(MFP.II.SLC.1.AR.Fit, "delta")
MFP_2.2_SLC_d <- ExtractFcn(MFP.II.SLC.2.AR.Fit, "delta")
MFP_2.3_SLC_d <- ExtractFcn(MFP.II.SLC.3.AR.Fit, "delta")
MFP_2.4_SLC_d <- ExtractFcn(MFP.II.SLC.4.AR.Fit, "delta")
MFP_2.5_SLC_d <- ExtractFcn(MFP.II.SLC.5.AR.Fit, "delta")
MFP_2.1_DivO_d <- ExtractFcn(MFP.II.DivOsc.1.AR.Fit, "delta")
MFP_2.2_DivO_d <- ExtractFcn(MFP.II.DivOsc.2.AR.Fit, "delta")
MFP_2.3_DivO_d <- ExtractFcn(MFP.II.DivOsc.3.AR.Fit, "delta")
MFP_2.4_DivO_d <- ExtractFcn(MFP.II.DivOsc.4.AR.Fit, "delta")
MFP_2.5_DivO_d <- ExtractFcn(MFP.II.DivOsc.5.AR.Fit, "delta")

## Plotting
### r ###
Models <- c("MFP_2.1_DO_r", "MFP_2.2_DO_r", "MFP_2.3_DO_r", "MFP_2.4_DO_r", "MFP_2.5_DO_r",
           "MFP_2.1_SLC_r", "MFP_2.2_SLC_r", "MFP_2.3_SLC_r", "MFP_2.4_SLC_r", "MFP_2.5_SLC_r",
           "MFP_2.1_DivO_r", "MFP_2.2_DivO_r", "MFP_2.3_DivO_r", "MFP_2.4_DivO_r", "MFP_2.5_DivO_r")
x.labs <- rep(c("TS 1", "TS 2", "TS 3", "TS 4","TS 5"), 5)
df.r <- data.frame(Models = rep(Models, each = 18000),
                   Est = c(MFP_2.1_DO_r, MFP_2.2_DO_r, MFP_2.3_DO_r, MFP_2.4_DO_r, MFP_2.5_DO_r,
                           MFP_2.1_SLC_r, MFP_2.2_SLC_r, MFP_2.3_SLC_r, MFP_2.4_SLC_r, MFP_2.5_SLC_r,
                           MFP_2.1_DivO_r, MFP_2.2_DivO_r, MFP_2.3_DivO_r, MFP_2.4_DivO_r, MFP_2.5_DivO_r),
                   TrueVal = rep(c(2.1, 2.5, 2.5), each = 90000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 90000))

AR.r <- ggplot(df.r, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  # ylim(0, 0.03) +
  labs(x = "", y = expression(paste("Model Estimates of ", beta))) +
...
df.d <- data.frame(Models = rep(Models, each = 3600),
                   Est = c(MFP_2.1_DO_d, MFP_2.2_DO_d, MFP_2.3_DO_d, MFP_2.4_DO_d, MFP_2.5_DO_d,
                           MFP_2.1_SLC_d, MFP_2.2_SLC_d, MFP_2.3_SLC_d, MFP_2.4_SLC_d, MFP_2.5_SLC_d,
                           MFP_2.1_DivO_d, MFP_2.2_DivO_d, MFP_2.3_DivO_d, MFP_2.4_DivO_d, MFP_2.5_DivO_d),
                   TrueVal = rep(c(0.34, 0.34, 0.41), each = 18000),
                   Model = rep(c("Damping Oscillations", "Stable Limit Cycle", "Divergent Oscillations"), each = 18000))

AR.d <- ggplot(df.d, aes(x = Models, y = Est, fill = Model)) +
  geom_violin() +
  scale_x_discrete(labels = x.labs, limits = Models) +
  #ylim(0, 0.03) +
  labs(x = "", y = expression(paste("Model Estimates of ", delta))) +
...
### Plotting Together ###
AR.Plots <- plot_grid(AR.r, AR.d, nrow = 2)
title <- textGrob("MFP Model, Type II FR | Autoregressive Model-Fitting")
x.lab <- textGrob("Generating Model and Corresponding Time Series")
grid.arrange(arrangeGrob(AR.Plots, top = title, bottom = x.lab))
```
